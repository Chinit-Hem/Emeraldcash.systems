...
const nextConfig = {
  ...
  allowedDevOrigins: ["localhost", "127.0.0.1", "10.1.80.100", "192.168.1.100", "192.168.195.1", "192.168.1.7", "192.168.0.135", "192.168.0.138", "192.168.0.139", "192.168.0.140", devLanIp].filter(Boolean),
