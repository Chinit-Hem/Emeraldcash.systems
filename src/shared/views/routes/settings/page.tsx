...
import { NeuSettingsSkeleton } from "@/shared/components/skeletons/NeuSettingsSkeleton";

// Lazy load the heavy settings component
const SettingsContent = dynamic(() => import("@/shared/components/settings/SettingsContent"), {
