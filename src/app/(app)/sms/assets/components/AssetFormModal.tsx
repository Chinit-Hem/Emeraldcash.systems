...
import { AlertCircle, Loader2, Package, Save, Upload, X } from 'lucide-react';
      ...
      <div className={smsModalPanelClass}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 p-5 sm:p-6">
          ...
          <div>
            ...
            <div className={`${smsDropzoneClass} text-center`}>
              <input
                id="image-upload"
                type="file"
              ...
              <label
                ...
                className="flex cursor-pointer flex-col items-center gap-2 rounded-lg p-5 text-sm text-gray-600 transition-colors hover:bg-emerald-50 dark:text-gray-300 dark:hover:bg-emerald-900/20"
              >
                ...
                <div>
                  ...
                  <p className={smsHelperClass}>PNG, JPG up to 10MB</p>
                </div>
                {uploadProgress > 0 && (
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <textarea
                ...
                className={`${smsTextareaClass} resize-y`}
