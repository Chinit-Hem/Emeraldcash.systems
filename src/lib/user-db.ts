...
export type Role = "System Administrator" | "Branch Manager" | "Loan Operations" | "Loan Specialist" | "Accountant" | "Assistant Accountant" | "Credit / Approver" | "Admin" | "Staff" | "Manager / Approver" | "Finance" | "Human Resources" | "Director" | "IT Support" | "Risk & Compliance" | "Marketing" | "Intern / Read Only" | "Executive Viewer";
...
const VALID_ROLES: Role[] = ["System Administrator", "Branch Manager", "Loan Operations", "Loan Specialist", "Accountant", "Assistant Accountant", "Credit / Approver", "Admin", "Staff", "Manager / Approver", "Finance", "Human Resources", "Director", "IT Support", "Risk & Compliance", "Marketing", "Intern / Read Only", "Executive Viewer"];
    ...
    await queryWithRetry(
      async () => sql`
        CREATE TABLE IF NOT EXISTS users (
          ...
          role VARCHAR(40) NOT NULL CHECK (role IN ('System Administrator', 'Branch Manager', 'Loan Operations', 'Loan Specialist', 'Accountant', 'Assistant Accountant', 'Credit / Approver', 'Admin', 'Staff', 'Manager / Approver', 'Finance', 'Human Resources', 'Director', 'IT Support', 'Risk & Compliance', 'Marketing', 'Intern / Read Only', 'Executive Viewer')),
    ...
    await queryWithRetry(
      async () => sql`
        ...
        BEGIN
          ...
          CHECK (role IN ('System Administrator', 'Branch Manager', 'Loan Operations', 'Loan Specialist', 'Accountant', 'Assistant Accountant', 'Credit / Approver', 'Admin', 'Staff', 'Manager / Approver', 'Finance', 'Human Resources', 'Director', 'IT Support', 'Risk & Compliance', 'Marketing', 'Intern / Read Only', 'Executive Viewer'));
        END $$;
      `,
