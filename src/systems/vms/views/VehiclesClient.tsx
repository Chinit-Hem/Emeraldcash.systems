...
import FiltersBar from "@/systems/vms/components/dashboard/FiltersBar";
import { NeuKpiCard } from "@/shared/components/ui/neu/NeuKpiCard";
import Pagination from "@/systems/vms/components/dashboard/Pagination";
import VehicleCardMobile from "@/systems/vms/components/dashboard/VehicleCardMobile";
import VehicleModal from "@/systems/vms/components/dashboard/VehicleModal";
import { GlassButton } from "@/shared/components/ui/glass/GlassButton";
import { useDeleteVehicleOptimistic } from "@/systems/vms/components/vehicles/useDeleteVehicleOptimistic";
...
import { normalizeCategoryLabel, normalizeConditionLabel } from "@/systems/vms/utils/analytics";
import { useVehicles } from "@/systems/vms/hooks/useVehicles";
import { isConfigError } from "@/systems/vms/api/api";
...
import { driveThumbnailUrl } from "@/shared/utils/drive";
...
export default function VehiclesClient() {
  ...
  const apiFilters = useMemo((): import("@/systems/vms/api/api").VehicleFilters => {
    const apiFilterParams: import("@/systems/vms/api/api").VehicleFilters = {};
