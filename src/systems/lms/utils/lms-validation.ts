...
export const staffSchema = z.object({
  ...
  role: z.enum(["System Administrator", "Branch Manager", "Loan Operations", "Loan Specialist", "Accountant", "Assistant Accountant", "Credit / Approver", "Admin", "Staff", "Manager / Approver", "Finance", "Human Resources", "Director", "IT Support", "Risk & Compliance", "Marketing", "Intern / Read Only", "Executive Viewer"]),
