...
export class LmsService extends BaseService<LmsCategoryEntity, LmsCategoryDB> {
  ...
  public async createStaff(input: CreateLmsStaffInput): Promise<ServiceResult<LmsStaffEntity>> {
    ...
    try {
      const validRoles = ["System Administrator", "Branch Manager", "Loan Operations", "Loan Specialist", "Accountant", "Assistant Accountant", "Credit / Approver", "Admin", "Staff", "Manager / Approver", "Finance", "Human Resources", "IT Support", "Risk & Compliance", "Marketing", "Intern / Read Only", "Executive Viewer"];
