...
import type {
  ...
  UpdateLmsStaffInput,
} from "@/systems/lms/types/lms-entities";
import {
  calculateCompletionPercentage,
  extractYoutubeVideoId,
} from "@/systems/lms/types/lms-schema";
import type { InitialLmsData, LessonWithStatus } from "@/systems/lms/types/lms-types";
import {
  ...
  lmsLessonRepository,
  lmsStaffRepository,
} from "@/systems/lms/api/LmsRepository";
...
export class LmsService extends BaseService<LmsCategoryEntity, LmsCategoryDB> {
  ...
  public async createStaff(input: CreateLmsStaffInput): Promise<ServiceResult<LmsStaffEntity>> {
    ...
    try {
      const validRoles = ["System Administrator", "Branch Manager", "Loan Operations", "Loan Specialist", "Accountant", "Assistant Accountant", "Credit / Approver", "Admin", "Staff", "Manager / Approver", "Finance", "Human Resources", "Director", "IT Support", "Risk & Compliance", "Marketing", "Intern / Read Only", "Executive Viewer"];
