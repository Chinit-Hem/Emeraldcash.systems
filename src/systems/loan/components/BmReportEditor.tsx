  ...
  return <section className="space-y-5 p-3 text-slate-900 dark:text-slate-100 sm:p-5">
    ...
    <div className={section === "overview" ? "space-y-5" : "hidden print:block"}>
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <Metric label={text("LS reports", "របាយការណ៍ LS")} value={daily.lsReports} helper={text("Today", "ថ្ងៃនេះ")} color="border-blue-200 bg-blue-50 text-blue-900 dark:border-blue-900 dark:bg-blue-950/30 dark:text-blue-200" />
        <Metric label={text("Account reports", "របាយការណ៍គណនេយ្យ")} value={daily.accountReports} helper={text("Today", "ថ្ងៃនេះ")} color="border-violet-200 bg-violet-50 text-violet-900 dark:border-violet-900 dark:bg-violet-950/30 dark:text-violet-200" />
